...
class FormLapKegiatan(forms.ModelForm):
    ...
    kegiatan = forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control'}))
    foto = forms.ImageField(widget=forms.FileInput(attrs={'class': 'img-pond '}))
